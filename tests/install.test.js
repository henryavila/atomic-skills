...
describe('installSkills', () => {
  ...
  it('copies the complete shared runtime closure to the claude-code namespace', async () => {
    ...
    assert.ok(files.includes('implement-automate-maestro.md'), '_assets/implement-automate-maestro.md must be installed');
    assert.ok(files.includes('implement-decision-log.md'), '_assets/implement-decision-log.md must be installed');
    ...
    assert.ok(
      existsSync(pjoin(assetsDir, 'providers', 'claude', 'invocation-canonical.txt')),
      'providers/claude/invocation-canonical.txt must be installed',
    );
    assert.ok(
      existsSync(pjoin(assetsDir, 'providers', 'claude', 'preflight-checks.txt')),
      'providers/claude/preflight-checks.txt must be installed',
    );
