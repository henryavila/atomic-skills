...
phases:
  - id: F0
        ...
        - id: F0-G1
          ...
          evidence:
            ...
            outputSummary: "  ✔ false for non-ISO / invalid timestamps under automate
              (0.102666ms)   ✔ true only with non-empty ISO timestamp under
              automate (0.059375ms)   ✔ optional validatorId does not alone
              satisfy the gate (0.034875ms) ✔ userValidationOk (0.454792ms) ℹ
              tests 45 ℹ suites 5 ℹ pass 45 ℹ fail 0 ℹ cancelled 0 ℹ skipped 0 ℹ
              todo 0 ℹ duration_ms 40.515708"
        - id: F0-G2
    ...
    evaluationGate:
      status: skipped
      reason: retroactive GATE-R4 backfill — phase closed before evaluationGate
        existed (implementation-automate-mode self-host)
