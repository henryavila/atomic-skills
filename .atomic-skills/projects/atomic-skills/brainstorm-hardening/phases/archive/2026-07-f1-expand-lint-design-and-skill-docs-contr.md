...
nextAction: Operator clearContinue then phase-start package for F2
...
exitGates:
  - id: G-F1-1
    ...
    evidence:
      ...
      testsCollected: 26
      passed: true
      outputSummary: node --test tests/lint-design.test.js 26 pass
    verifierLabel: "test: node tests/lint-design.test.js"
    evidenceSummary: passed · 26 tests · 2026-07-30
stack:
  - id: 1
    title: Expand lint-design and skill docs contract
    type: task
...
## Self-review (phase-done)
- G1: exit gate re-ran 26/26
- **CROSS-MODEL REVIEW**: mode=both local+codex @ 89fd6384e4d2 file=.atomic-skills/reviews/2026-07-30-both-brainstorm-hardening-F1.md
