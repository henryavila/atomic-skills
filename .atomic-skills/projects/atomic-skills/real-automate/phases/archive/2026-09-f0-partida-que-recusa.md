...
tasks:
  - id: T-001
    ...
    status: done
    lastUpdated: 2026-09-25T22:29:38.032Z
    outputs:
      - kind: file
    ...
    verifier:
      ...
      expectExitCode: 0
    closedAt: 2026-09-25T22:29:38.032Z
    evidence:
      verifierKind: shell
      verifiedAt: 2026-09-25T22:29:38.032Z
      verifiedCommit: e829cf055b0d6285fe3f43580cbdc084993cfadc
      passed: true
      exitCode: 0
  ...
  - id: T-002
    ...
    description: "`src/providers/skills-file-set.js` e
      ...
      Verifier: `node --test tests/automate-host-pen.test.js`."
    status: done
    lastUpdated: 2026-09-25T22:29:38.996Z
    outputs:
      - kind: file
    ...
    verifier:
      ...
      command: node --test tests/automate-host-pen.test.js
      expectExitCode: 0
    closedAt: 2026-09-25T22:29:38.996Z
    evidence:
      verifierKind: shell
      verifiedAt: 2026-09-25T22:29:38.996Z
      verifiedCommit: 5d16d7244dd604380644e99ec275d21650cfb2e5
      passed: true
      exitCode: 0
      outputSummary: "node --test tests/automate-host-pen.test.js on merged HEAD
        1435d1c3: ℹ tests 12 ℹ pass 12 ℹ fail 0 exit=0. Includes pen matcher,
  ...
  - id: T-003
    ...
    verifier:
      ...
      command: node --test tests/automate-host-pen.test.js
      expectExitCode: 0
    closedAt: 2026-09-25T22:29:39.928Z
    evidence:
      verifierKind: shell
      verifiedAt: 2026-09-25T22:29:39.928Z
      verifiedCommit: a191deb14723bbad94beafa56b48617ea9c90453
      passed: true
      exitCode: 0
      outputSummary: "node --test tests/automate-host-pen.test.js on merged HEAD
        1435d1c3: ℹ tests 12 ℹ pass 12 ℹ fail 0 exit=0. Includes pen matcher,
