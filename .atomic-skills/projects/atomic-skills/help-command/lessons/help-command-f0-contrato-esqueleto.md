...
lessons:
  - id: L-001
    statement: O asset F0 parafraseou "reusar o mecanismo de `status --browser`" como
      o comando cru `open`/`xdg-open`, descartando silenciosamente o guard WSL2
      embutido no helper canônico `open_url`.
    corrective: Em qualquer spec/asset que delega a outro mecanismo (o `--html` de
      ...
      `project-view.md`), nunca o comando cru — e valide que o comando citado casa
      o canônico.
    scope: reusable
    appliesTo:
      - F2
  ...
  - id: L-002
    ...
    status: open
    confidence: 2
    evidence: "review-code local finding #2 (phase-done F0)"
    createdAt: 2026-07-05T12:40:24Z
    validatedAt: 2026-07-05T12:40:24Z
---
