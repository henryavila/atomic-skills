...
nextAction: "F2/F3 re-escopados package-first (2026-06-19, decisões do usuário aplicadas ao plan.md). Falta gate do usuário: validar o pacote ~/tooling-installer (npm test 38/38). Depois implement retoma F2 no repo do pacote, F3 no atomic-skills. NÃO rodar phase-done F1 (done/superseded)."
