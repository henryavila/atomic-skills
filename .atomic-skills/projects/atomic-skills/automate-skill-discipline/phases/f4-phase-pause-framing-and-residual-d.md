...
nextAction: "Plan end: external-both + userValidatedAt before finalize (automate
  HARD-BLOCK)"
...
exitGates:
  - id: F4-G1
    ...
    evidence:
      ...
      exitCode: 0
      outputSummary: ok
    verifierLabel: "shell: node --test tests/maestro-cursor.test.js tests/assert-autom…"
  ...
  - id: F4-G2
    ...
    evidence:
      ...
      exitCode: 0
      outputSummary: ok
    verifierLabel: "shell: test ! -e skills/core/automate.md && node --test tests/phas…"
    evidenceSummary: passed · 2026-07-21
stack:
  - id: 1
    title: Phase pause, framing, and residual discipline (R5 + P1)
