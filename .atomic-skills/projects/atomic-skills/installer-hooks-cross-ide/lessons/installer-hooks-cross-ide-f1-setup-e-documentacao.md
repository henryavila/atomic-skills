...
lessons:
  - id: L-001
    ...
    corrective: Quando um gate combinar teste Node e teste shell, usar comando
      shell explicito como `node --test tests/project.test.js && bash
    ...
    validatedAt: 2026-07-09T13:18:57Z
---
