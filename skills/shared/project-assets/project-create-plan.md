...
Quando nenhum outro plano ativo existe (caso solo), o padrão explícito é `branch: null`: o plano permanece na árvore atual e só cria `plan/<slug>` sob concorrência (≥1 outro plano ativo).
