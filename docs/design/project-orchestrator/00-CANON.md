...
**Forks RESOLVED (2026-06-01) — the design is decision-complete for v1** (`05-fork-resolutions.md`). The six immediate-build forks (F-B1…B5, F-D1) are settled, so **Inc0 + the Inc1 linchpin are fully unblocked and spec'd.**
