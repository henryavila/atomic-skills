...
export const SKILLS: Skill[] = [
  ...
  },
  {
    ...
    subcommands: [
      ...
      { name: "why", signature: "<id>", description: "Show full context for a task / phase / parked / emerged entry", example: "/atomic-skills:project-status why T-005" },
      ...
      { name: "review-due", signature: "", description: "Cross-model codex review against the diff since last review", example: "/atomic-skills:project-status review-due" },
    ],
    args: [
  ...
  },
  {
    ...
    subcommands: [
      { name: "discover", signature: "[--dry-run|--commit] [--scope=<list>] [--scan=<path>]", description: "Multi-source scan + cluster + synthesize → propose Plans + Initiatives", example: "/atomic-skills:project-plan discover" },
      ...
      { name: "new", signature: "<slug>", description: "Create a new Initiative (standalone or under active plan)", example: "/atomic-skills:project-plan new my-feature" },
      { name: "new-task", signature: "\"<title>\" [--target <phaseId>] [--blocked-by <id>] [--tags ...]", description: "Add a task to current OR specified initiative (records provenance + requires ratified context)", example: "/atomic-skills:project-plan new-task --target F2 \"Add canary smoke test\"" },
      { name: "new-phase", signature: "<id> \"<title>\" --after <other-id>", description: "Insert a new phase into the active plan + materialize its initiative (requires ratified context)", example: "/atomic-skills:project-plan new-phase F0.5 \"Validation\" --after F0" },
      { name: "split-phase", signature: "<id>", description: "Split an over-sized phase into two sub-phases (archives the original; ratify each new phase)", example: "/atomic-skills:project-plan split-phase F2" },
      { name: "migrate", signature: "<slug>", description: "Migrate a legacy initiative file to schemaVersion 0.1", example: "/atomic-skills:project-plan migrate sample-legacy" },
      { name: "re-bootstrap", signature: "<slug>", description: "Batch re-articulate placeholder context after migrate", example: "/atomic-skills:project-plan re-bootstrap sample-legacy" },
    ],
    args: [
